...
export const AuditEventType = {
  ...
  BOOKING_TRAVELLER_ADDED: "BOOKING_TRAVELLER_ADDED",
  BOOKING_TRAVELLER_UPDATED: "BOOKING_TRAVELLER_UPDATED",
  BOOKING_TRAVELLER_REMOVED: "BOOKING_TRAVELLER_REMOVED",
  BOOKING_PAYMENT_RECORDED: "BOOKING_PAYMENT_RECORDED",
  BOOKING_PAYMENT_FAILED: "BOOKING_PAYMENT_FAILED",
  BOOKING_PAYMENT_ADJUSTED: "BOOKING_PAYMENT_ADJUSTED",
  BOOKING_REFUND_RECORDED: "BOOKING_REFUND_RECORDED",
  BOOKING_NOTE_ADDED: "BOOKING_NOTE_ADDED",
  BOOKING_DOCUMENT_ADDED: "BOOKING_DOCUMENT_ADDED",
