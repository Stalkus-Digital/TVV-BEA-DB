...
/** Internal helper, not exported from repositories/index.ts — same in-memory-CRUD pattern hand-rolled per module as Package/Quote/Inventory/Destination/Supplier's own repositories. */
