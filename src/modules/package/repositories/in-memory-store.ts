...
/**
 * Internal helper, not exported from repositories/index.ts — every one of
 * this module's seven repositories (Package, PackageDay, PackageItem,
 * PackagePricing, PackageRule, PackageAvailability, PackageVersion) wraps
 * this instead of re-implementing the same in-memory CRUD seven times.
 * Same underlying pattern as Inventory's, Supplier's, and Destination's
 * repositories — no database yet.
 */
