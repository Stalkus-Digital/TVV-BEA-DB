...
const PackageGeneratorSchema = z.object({
  ...
  shortDescription: z.string().describe("A short engaging description of the package").optional(),
  itineraryDetails: z.string().describe("Rich text HTML format itinerary overview").optional(),
  rules: z.array(z.string()).describe("Package rules and regulations").optional(),
...
const JSON_EXAMPLE = `{
  ...
  "durationNights": 4,
  "basePrice": 85000,
  "shortDescription": "Discover the pristine beaches and historical landmarks of the Andamans on this 5-day getaway.",
  "itineraryDetails": "<h3>Day 1: Arrival</h3><p>Welcome to Port Blair.</p>",
  "rules": ["Valid ID required", "Check-in after 2 PM"],
