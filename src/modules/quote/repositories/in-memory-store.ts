...
/**
 * Internal helper, not exported from repositories/index.ts — same
 * in-memory-CRUD pattern as Package/Inventory/Destination/Supplier's own
 * repositories, hand-rolled per module rather than shared (no database
 * yet, no cross-module business logic per docs/02).
 */
