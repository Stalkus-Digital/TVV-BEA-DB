...
/** Rejects non-image categories before delegating to the shared mime/size/content rules in `uploads/file-validation.ts`. */
export function validateImageUpload(category: StorageCategory, contentType: string, size: number, buffer: Buffer): Result<void, AppError> {
